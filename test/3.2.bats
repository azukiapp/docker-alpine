setup() {
  docker history "azukiapp/alpine:3.2" >/dev/null 2>&1
}
...
@test "repository list is correct" {
  ...
  [ "${lines[1]}" = "@edge http://nl.alpinelinux.org/alpine/edge/main/" ]
  [ "${lines[2]}" = "@testing http://nl.alpinelinux.org/alpine/edge/testing/" ]
}
